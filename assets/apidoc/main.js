require.config({
    paths: {
        bootstrap: '/apidoc/vendor/bootstrap.min',
        diffMatchPatch: '/apidoc/vendor/diff_match_patch.min',
        handlebars: '/apidoc/vendor/handlebars.min',
        handlebarsExtended: '/apidoc/handlebars_helper',
        jquery: '/apidoc/vendor/jquery.min',
        locales: '/apidoc/locales/locale',
        lodash: '/apidoc/vendor/lodash.min',
        pathToRegexp: '/apidoc/vendor/path-to-regexp/index',
        prettify: '/apidoc/vendor/prettify/prettify',
        utilsSampleRequest: '/apidoc/utils/send_sample_request',
    },
    shim: {
        bootstrap: {
            deps: ['jquery']
